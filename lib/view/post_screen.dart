...
class PostItemComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return !allUserController.blockedUserList.contains(postData.creatorId)
        ? FutureBuilder(
            future: allUserController.fetchIsBlockedStatus(postData.creatorId!),
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return Center(child: PostShimmerWidget());
                          ...
                          GestureDetector(
                              onTap: () {
                                postData.creatorId != controller.loggedInUserId
                                    ? Get.to(() =>
                                        ProfileScreen(postData.creatorId!))
                                    : null;
                              },
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  postData.postComments?.length.toString() ??
                                      "0",
                                  style: Theme.of(context)
                                      .textTheme
                                      .labelLarge!
