...
class ProfileScreen extends StatelessWidget {
            ...
            appBar: AppBar(
              ...
              actions: [
                ...
                (FirebaseAuth.instance.currentUser!.uid != userId)
                    ? IconButton(
                        onPressed: () async {
                          String? result = await showReportDialog(
                              context, 'User',
                              isForUser: true);
                          if (result != null) {
                            progressDialogue(context,
                                title: "Reporting user...");
                            await controller.reportOtherUser(
                                reason: result,
                                reporterId:
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              TextButton(
                                  onPressed: () async {
                                    // todo: implement view all posts
                                    await Get.to(() => PostListScreen(
                                          streamQuery: postController
  ...
  Widget StreamedText(BuildContext context, Stream<String> stream) {
